...
app.controller('ResultsCtrl', function ($scope,CheckLoggedIn, $location, SearchRestaurants, $state, SharedData, SendRating, GetRating) {
  ...
  $scope.restaurants = [
    { id: 'gary-danko-san-francisco', name: 'Gary Danko', users: ['arianf', 'devmeyster', 'rob'],         rating: 4.5, photo_url:"http://hamelfamilywines.com/wp-content/uploads/2013/01/Gary-Danko1.jpg" },
